...
class UpdateSubmittedAssignment extends Component {
    constructor(){
        super();
      ...
      console.log(this.state.id);
       ...
       var requestOptions = {
         ...
         fetch("https://zinedu-main.herokuapp.com/student/update-submitted-assignment/"+this.state.id+"/",requestOptions)
       ...
       componentDidMount=()=>{
        var formdata = new FormData();
        formdata.append('page_name','student-updateassignment');
       var requestOptions = {
           method: 'POST',
           body: formdata,
           redirect: 'follow',
         ...
         this.setState({ id:this.props.location.state.assignment.id,
                         assign_file:this.props.location.state.assignment.assignment_assoc.assignment_file,
                         assign_icon:this.props.location.state.assignment.assignment_assoc.assignment_icon,
                         assign_student:this.props.location.state.assignment.assignment_pdf,
                         isloading:false,
                        })
       }
...
<Studentnav  history={this.props.history}/>
  ...
  <div className="form-group">
      ...
      <div className="form-group">
      <div className="col-md-12">
      <label style={form3}>Your Submittion:</label><br/>
      <a href={this.state.assign_student} target='_blank'>  <i style={{fontSize:'30px'}}  class="fas fa-file"></i></a>
      </div>
  </div>
      <div className="form-group">
      <div className="col-md-12">
      <label style={form3}>Updated Assigment File:</label><br/>
...
export default UpdateSubmittedAssignment;