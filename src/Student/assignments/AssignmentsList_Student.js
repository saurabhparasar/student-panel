...
const AssignmentsList_student = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get(Config.SERVER_URL + 'student/get-scheduled-objective-exams/?student=' + student + '&type=' + props.location.state.exam_type+'&chapter='+props.location.state.chapter, requestOptions)
            .then(response => {
                let lang = response.data;
                console.log(lang);
                setTests(lang)
        ...
        axios.get(Config.SERVER_URL + 'student/get-given-objective_exams/?student=' + student + '&type=' + props.location.state.exam_type+'&chapter='+props.location.state.chapter, requestOptions)
            .then(response => {
                let lang = response.data;
                console.log(lang);
                setTests_given(lang)
