...
const AssignmentsList_student = (props) => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                Config.SERVER_URL +
                "student/get-given-objective_exams/?student=" +
                student +
                "&type=" +
                props.location.state.exam_type +
                "&chapter=" +
    ...
    function jeeadvance() {
        window.open(
            `https://class.zinedu.com/WEBStudent/JEEAdvancePageAccess?StudentReferenceId=${student_id}`
        );
    }
    var examType;
                ...
                <div style={{ float: "right" }}>
                    {sectionid === 303 ? (
                        <button
                            ...
                            onClick={jeeadvance}
                        >
                            CLICK HERE FOR JEE ADVANCE TEST SERIES
                        </button>
                    ) : (
                        ""
                    )}
                    <a
                        href={
                            "https://class.zinedu.com/WEBStudent/StudentPageAccess?PageName=ObjectivePaidExamList&StudentId=" +
                            student_id
                        }
                        className="btn btn-primary"
                    >
                        View Previous Exams and Results
                    </a>
                </div>
            </div>
        );
        ...
        examType = (
            <div>
                ...
                <div style={{ float: "right" }}>
                    <a
                        href={
                            "https://class.zinedu.com/WEBStudent/StudentPageAccess?PageName=MyAssignment&StudentId=" +
                            student_id
                        }
                        className="btn btn-primary"
                    >
        ...
        examType = (
            <div>
                ...
                <div style={{ float: "right" }}>
                    <a
                        href={
                            "https://class.zinedu.com/WEBStudent/StudentPageAccess?PageName=TakeQuiz&StudentId=" +
                            student_id
                        }
                        className="btn btn-primary"
                    >
                        View Previous Quizes
                    </a>
                </div>
            </div>
        );
                                ...
                                <MaterialTable
                                    ...
                                    columns={[
                                        ...
                                        },
                                        {
                                            ...
                                            render: (rowData) => (
                                                <div>
                                                    {dateFormat(rowData.end_date, "d/m/yyyy,h:MM:ss TT ")}
                                                </div>
                                            ),
                                        },
                                        {
                                        ...
                                        // {title: '', field: 'Check', render: rowData => <div>{rowData.exam_given=="Yes"?(<div></div>):(<div></div>)}</div>},
                                        {
                                            ...
                                            render: (rowData) => (
                                                <div>
                                                    {rowData.attending_status === "LateSubmission" ? (
                                                        <div>
                                                            <p
                                                                style={{
                                                                    color: "#FF1100",
                                        ...
                                        },
                                        {
                                            ...
                                            render: (rowData) => (
                                                <div>
                                                    {rowData.exam_given === "Yes" ? (
                                                        <div>
                                                            <img
                                                                onClick={() => {
                                                                    onResultclick(rowData);
                                                                }}
                                                                src={process.env.PUBLIC_URL + "/test 1.png"}
                                                                style={{
                                                                    width: "30px",
                                                                    height: "30px",
                                                                    cursor: "pointer",
                                    ...
                                    columns={[
                                        ...
                                        { title: "Test Name", field: "exam_assoc.exam_topic" },
                                        {
                                            ...
                                            render: (rowData) => (
                                                <div>
                                                    {dateFormat(
                                                        rowData.exam_assoc.exam_start_date,
                                                        "d/m/yyyy, h:MM:ss TT "
                                                    )}
                                                </div>
                                            ),
                                        },
                                        {
                                            ...
                                            render: (rowData) => (
                                                <div>
                                                    {dateFormat(
                                                        rowData.exam_assoc.exam_end_date,
                                                        "d/m/yyyy,h:MM:ss TT "
                                                    )}
                                                </div>
                                            ),
                                        ...
                                        },
                                        {
                                            ...
                                            render: (rowData) => (
                                                <div>
                                                    <img
                                                        onClick={() => {
                                                            onResultclickAttempted(rowData);
                                                        }}
                                                        src={process.env.PUBLIC_URL + "/test 1.png"}
                                                        style={{
                                                            width: "30px",
...
export default AssignmentsList_student;
