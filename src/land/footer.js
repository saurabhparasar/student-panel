          ...
          <div className="container">
            <div className="row" id={Style.gap1}>
              <div className="col-md-4">
                <img
                  className="group-1"
                  src="https://anima-uploads.s3.amazonaws.com/projects/5fec5bb9441305656b529bd5/releases/5fed67c3c303bd492582d63e/img/group-1@2x.svg" alt=""
                />
                <p id={Style.text1}>
                  We are highly passionate team of IITians and ISBians, who
                  aspire to transform the education landscape of the country
