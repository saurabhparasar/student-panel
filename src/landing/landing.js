    ...
    fetch(Config.SERVER_URL + 'login/', requestOptions)
      ...
      .then(json => {
        if (typeof (json.token) != "undefined") {
          ...
          fetch(Config.SERVER_URL + 'users/get-user-type/?username=' + this.state.username, getreq)
            .then(response => response.json())
            .then(json => {
              this.setState({
      ...
      <div className="login-container">
        <form onSubmit={this.onSubmithandler}>
          ...
          <div className="username-input">
            <input type="text" placeholder="Username" name="useraname" onChange={this.onusernamechange} required />
          </div>
          <div className="password-input">
            <input type="password" placeholder="Password" name="password" onChange={this.onpasswordchange} required />
          </div>
